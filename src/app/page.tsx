  ...
  return (
    <main className="font-sans selection:bg-black/10">
      ...
      <section className="relative w-full h-[100svh] bg-[#f4f4f0] text-[#111] overflow-hidden flex flex-col justify-center">
        ...
        <div className="relative w-full max-w-[100rem] mx-auto px-6 lg:px-12 py-12 lg:py-0 flex flex-row items-center justify-between h-full gap-4 lg:gap-0">

          {/* Left: Typography & CTA */}
          <div className="w-[50%] sm:w-[55%] lg:w-[60%] flex flex-col justify-center relative h-full">
          ...
          <div className="w-[45%] sm:w-[40%] lg:w-auto lg:h-[75vh] xl:h-[80vh] flex flex-col lg:block items-center justify-center z-10 relative">
            ...
            <div className="absolute top-0 left-0 w-full h-full lg:hidden z-20 pointer-events-none">
              ...
              {/* Mobile Element 2 */}
              <div className="absolute -top-2 -right-4 w-[60%] aspect-video overflow-hidden shadow-[0_20px_40px_-10px_rgba(0,0,0,0.6)] bg-neutral-200 transform rotate-6 z-20 pointer-events-auto">
                <Image src="/hero_element_2.jpeg" alt="Workspace Setup" fill className="object-cover object-center" />
              </div>
            </div>

            {/* Desktop Overlapping Element 1 (Code/Diagram) - Positioned Top Left of Main Image */}
            <div className="hidden lg:block absolute top-[10%] -left-12 xl:-left-24 w-48 xl:w-72 aspect-video z-30 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.4)] overflow-hidden transform -rotate-3 pointer-events-none">
              <Image src="/hero_element_1.jpeg" alt="Architecture Diagram" fill className="object-cover" />
            </div>

            {/* Desktop Overlapping Element 2 (Keyboard/Laptop) - Positioned Bottom Left of Main Image */}
            <div className="hidden lg:block absolute bottom-[15%] -left-16 xl:-left-28 w-40 xl:w-64 aspect-video z-30 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.4)] overflow-hidden transform rotate-6 pointer-events-none">
