...
export default function AdminLogin() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md p-6 md:p-8 rounded-[9px] bg-white/5 border border-white/10 backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <input
              ...
              className="w-full bg-[#0a0a0a] border border-white/10 rounded-[9px] px-4 py-3 text-base text-white focus:outline-none focus:border-white/50 focus:ring-1 focus:ring-white/50 transition-all text-center tracking-[0.3em]"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-white text-black font-semibold rounded-[9px] px-4 py-3 hover:bg-neutral-200 transition-colors"
          >
            Authenticate
          </button>
        </form>
